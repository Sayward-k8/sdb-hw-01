...
<details> 
  ...
  1. Начало транзакции
  2. Проверка баланса
  3. Списание суммы со счета
  4. Зачисление суммы на баланс телефона
  5. Отчет о выполнении
  6. Завершение операции
  
  2.1.* Пополнение счёта телефона через автоплатёж
  
  1. Настройка автоплатежа на определенную дату
  2. Создание транзакции
  3. Проверка баланса
  4. Зачисление денег на баланс телефона
  5. Завершение транзакции и уведомление  клиента
  6. Повтор при ошибке операции
